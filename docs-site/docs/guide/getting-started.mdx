...
- Explore [AI Integration](/docs/guide/ai/) to set up AI coding agents
- Understand the [Core Philosophy](/docs/guide/understanding) behind LeanSpec
- Review [First Principles](/docs/guide/understanding#the-five-first-principles) to understand the foundational constraints
...
- Read [Best Practices](/docs/guide/ai/best-practices) for tips on effective spec writing
