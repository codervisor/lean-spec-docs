...
You now understand [what LeanSpec is](/docs/guide/understanding) and [how to write specs](/docs/guide/writing-specs). This guide helps you decide **when** to apply LeanSpec—and when not to.
