...
:::info
Even with date folders, sequence numbers remain globally unique starting with v0.2.0.
:::
...
4. Open an issue: [GitHub Issues](https://github.com/codervisor/lean-spec/issues)
...
- **[Configuration](/docs/reference/config)** - Complete config reference
- **[Getting Started](/docs/guide/getting-started)** - Initialize a new project
