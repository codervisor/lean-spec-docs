...
| ADR | 20 | 45 min | 🔴 Complex |
| ADR | 100 | 3 hrs | 🔴 Complex |
...
- **Examples**: See [spec 063](https://github.com/codervisor/lean-spec/tree/main/specs/063-migration-from-existing-tools) for detailed examples
...
1. **Learn the workflow**: [Creating & Managing Specs](/docs/guide/usage/essential-usage/creating-managing)
2. **Set up AI integration**: [MCP Integration](/docs/guide/usage/ai-assisted/mcp-integration)
3. **Understand principles**: [First Principles](/docs/guide/first-principles)
