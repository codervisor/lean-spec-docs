...
**Related**: See [First Principles](/docs/guide/first-principles) for the foundational constraints, or explore [Sub-Spec Files](/docs/reference/cli#sub-spec-files) for practical implementation of partitioning.
