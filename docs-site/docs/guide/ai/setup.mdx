...
See the [AGENTS.md Template](/docs/guide/ai/agents-md) for a complete example.
...
- Read [AGENTS.md Template](/docs/guide/ai/agents-md) for complete template
- Check [Best Practices](/docs/guide/ai/best-practices) for tips
- See [Examples](/docs/guide/ai/examples) for real-world patterns

---

Ready to level up? Explore [Best Practices](/docs/guide/ai/best-practices) next.
