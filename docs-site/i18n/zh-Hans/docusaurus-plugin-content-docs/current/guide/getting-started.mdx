...
**学习基础知识：**
- [第一原则](/docs/guide/first-principles) - 5 个基础原则
- [理解 LeanSpec](/docs/guide/understanding) - 核心概念和使用场景
- [上下文工程](/docs/guide/context-engineering) - 管理 AI 工作记忆
...
- 阅读[哲学与思维方式](/docs/guide/philosophy)获取有效规范编写技巧
