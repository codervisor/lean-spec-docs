...
Want to follow along with a ready-made dashboard project? Start with below instructions:
...
<Tabs groupId="ai-tool">
  <TabItem value="copilot" label="GitHub Copilot CLI">
    ...
    copilot -p "Help me add three new widgets to this dashboard using LeanSpec" \
      --files specs/ \
      --add-dir .
    ```
  </TabItem>
  <TabItem value="claude" label="Claude Code">
    ...
    claude prompt \
      "Help me add three new widgets to this dashboard using LeanSpec" \
      --include-files specs/ \
      --include-dir .
    ```
  </TabItem>
  <TabItem value="gemini" label="Gemini CLI">
    ...
    ```bash
    gemini -p "Help me add three new widgets to this dashboard using LeanSpec"
    ```
  </TabItem>
  <TabItem value="ide" label="IDE" default>
    ...
    3. Send the prompt: _"Help me add three new widgets to this dashboard using LeanSpec"_
  </TabItem>
</Tabs>
