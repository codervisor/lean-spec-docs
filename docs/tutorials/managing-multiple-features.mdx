...
:::info Prerequisites
- Completed [Your First Feature with AI](./writing-first-spec-with-ai)
- Basic familiarity with LeanSpec commands
:::

## Quick Start

Want to follow along with a ready-made dashboard project? Scaffold it instantly:
...
Then ask your AI: _"Help me add three new widgets to this dashboard using LeanSpec"_
