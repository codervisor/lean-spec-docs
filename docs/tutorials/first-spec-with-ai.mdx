...
Want to follow along with a ready-made example project? Start with below instructions:
...
<Tabs groupId="ai-tool">
  ...
  <TabItem value="claude" label="Claude Code">
    ...
    # Reference AGENTS.md to CLAUDE.md
  ...
  <TabItem value="ide" label="IDE" default>
    Then copy and paste into your AI IDE tool (VS Code, Cursor, Antigravity, etc.) with below prompt:
    
    ```
    Help me add dark theme support with theme switcher
    ```
  </TabItem>
</Tabs>
