...
Want to follow along with a refactoring-ready project? Scaffold it instantly:
...
Then ask your AI: _"Help me refactor this app using LeanSpec to extract a reusable API client"_
