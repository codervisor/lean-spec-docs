...
<Tabs groupId="ai-tool">
  <TabItem value="copilot" label="GitHub Copilot CLI">
    ...
    copilot -p "Help me refactor this app using LeanSpec to extract a reusable API client" \
      --files specs/ \
      --add-dir .
    ```
  </TabItem>
  <TabItem value="claude" label="Claude Code">
    ...
    claude prompt \
      "Help me refactor this app using LeanSpec to extract a reusable API client" \
      --include-files specs/ \
      --include-dir .
    ```
  </TabItem>
  <TabItem value="gemini" label="Gemini CLI">
    ...
    ```bash
    gemini -p "Help me refactor this app using LeanSpec to extract a reusable API client"
    ```
  </TabItem>
  <TabItem value="ide" label="IDE" default>
    ...
    3. Send the prompt: _"Help me refactor this app using LeanSpec to extract a reusable API client"_
  </TabItem>
</Tabs>
