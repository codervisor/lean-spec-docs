...
| **Workflow** | Flexible (see [writing modes](/docs/guide/usage/ai-assisted/writing-specs-with-ai#the-three-modes)) | 5-step process | Proposal→Archive | Autonomous agents | Tickets/sprints | Prompt |
