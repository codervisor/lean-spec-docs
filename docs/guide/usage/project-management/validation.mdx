...
- Use `lean-spec tokens --all --sort-by tokens` for stricter checks during reviews
...
✅ Passed (43 specs)
  • 040-api-design: 1,140 tokens ✅
  • 041-testing-strategy: 1,020 tokens ✅
  • 043-launch-plan: 1,310 tokens ✅
  ...

⚠️  Warnings (1 spec)
  • 058-docs-restructure: 3,620 tokens
    → Approaching limit, consider simplifying or splitting

🔴 Errors (1 spec)
  • 042-complex-feature: 5,180 tokens
    → Exceeds limit, must split into sub-specs
    → Recommendation: Move plan + rollout into DESIGN.md / IMPLEMENTATION.md
...
- **[Understanding LeanSpec](/docs/guide/understanding-leanspec)** - First Principles and Context Economy
