...
The `validate` command checks specs against quality standards defined by the [First Principles](/docs/guide/first-principles), particularly **Context Economy** (specs must fit in working memory).
