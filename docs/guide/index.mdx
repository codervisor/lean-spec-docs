...
*   [**Core CLI**](/docs/guide/usage/essential-usage): Manage specs, track status, and visualize dependencies (`lean-spec board`, `lean-spec deps`).
*   [**MCP Server**](/docs/guide/usage/ai-assisted/mcp-integration): Give AI agents (Claude, Cursor, etc.) direct access to read and search your specs.
*   [**Visual Mode**](/docs/guide/usage/visual-mode): A beautiful web interface for browsing your project's spec graph (`lean-spec ui`).
