...
**Visual Mode** - Web UI for browsing and managing specs:
- Interactive spec browser with rich formatting
- Dependency graph visualization
- Board view (Kanban-style) organized by status
- Run with `lean-spec ui` or `npx @leanspec/ui`
- [Learn more →](/docs/guide/visual-mode)
...
Want to understand the foundational constraints? Start with [Understanding LeanSpec](/docs/guide/understanding-leanspec) to see why LeanSpec is designed the way it is.
