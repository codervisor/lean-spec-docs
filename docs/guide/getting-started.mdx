...
- [Understanding LeanSpec](/docs/guide/understanding) - Core concepts and when to use
...
- [Spec Structure](/docs/guide/usage/essential-usage/spec-structure) - Anatomy of a good spec

**AI Integration:**
- [Agent Configuration](/docs/guide/usage/ai-assisted/agent-configuration) - AGENTS.md setup
- [MCP Integration](/docs/guide/usage/ai-assisted/mcp-integration) - Enable semantic memory
...
- Read [Philosophy & Mindset](/docs/guide/philosophy) for tips on effective spec writing
