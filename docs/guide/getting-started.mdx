...
- **AI Tool**: If you plan to integrate with AI coding agents (like [GitHub Copilot](https://github.com/features/copilot), [Claude Code](https://www.claude.com/product/claude-code), etc.), make sure you have your preferred tool set up.
