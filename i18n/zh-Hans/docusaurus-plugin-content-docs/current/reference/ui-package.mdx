...
`@leanspec/ui` 是一个基于 Next.js 的网页应用程序，为浏览和管理 LeanSpec 规范提供可视化界面。它发布在 npm 上，可以直接使用 `npx` 运行或全局安装。
...
**直接文件访问：**
- 从规范目录读取 `README.md` 文件
- 解析前置元数据和 markdown 内容
- 无需数据库或持久存储
