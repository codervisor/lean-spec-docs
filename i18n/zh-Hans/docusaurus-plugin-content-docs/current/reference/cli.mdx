...
文件：
  ...
  README.md                 1,923 tokens (287 行)
  DESIGN.md                   654 tokens (98 行)
  TESTING.md                  270 tokens (41 行)
...
**性能指示：**
- ✅ 优秀 (&lt;2,000 tokens) - 基线 AI 表现（100% 有效）
- 👍 良好 (2,000-3,500 tokens) - 轻微退化，可接受（95% 有效）
- ⚠️ 警告 (3,500-5,000 tokens) - 考虑拆分或精简（85% 有效）
- 🔴 问题 (&gt;5,000 tokens) - 应拆分（70% 有效）
