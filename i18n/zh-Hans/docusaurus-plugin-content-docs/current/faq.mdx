...
如果您的规范超过 3,500 令牌，请将其拆分为子规范文件（`DESIGN.md`、`IMPLEMENTATION.md`、`TESTING.md` 等）；超过 5,000 令牌必须立即拆分。详见[第一原则](/zh-Hans/docs/advanced/first-principles#1-context-economy-)。
