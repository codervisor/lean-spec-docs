...
![规范详情视图展示元数据、操作按钮和正文内容](/img/ui/ui-spec-detail.png)
...
![依赖关系图弹窗，包含当前规范与关联工作的节点](/img/ui/ui-dependency-graph.png)
...
需要立即定位规范？搜索框输入后实时刷新，列表和看板都会同步过滤。
...
- [管理规范](/docs/guide/usage/cli/creating-managing)
