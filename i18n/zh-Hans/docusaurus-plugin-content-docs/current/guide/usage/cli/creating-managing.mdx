...
**另见**：[子规范文件](/zh-Hans/docs/guide/usage/spec-structure#sub-spec-files)
...
**另见**：[验证](/zh-Hans/docs/guide/usage/cli/project-management#validation)
...
**另见**：[查找规范](/zh-Hans/docs/guide/usage/cli/finding-specs)
...
- [规范结构](/zh-Hans/docs/guide/usage/spec-structure) - 理解规范结构
