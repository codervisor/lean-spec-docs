...
flowchart LR
    ...
    style A fill:#e1f5ff,stroke:#1e3a8a,stroke-width:2px
    style B fill:#fff4e1,stroke:#92400e,stroke-width:2px
    style C fill:#f0e1ff,stroke:#6b21a8,stroke-width:2px
    style D fill:#e1ffe1,stroke:#166534,stroke-width:2px
    style E fill:#ffe1e1,stroke:#991b1b,stroke-width:2px
```
