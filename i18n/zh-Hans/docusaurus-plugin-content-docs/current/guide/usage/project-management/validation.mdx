...
- 提交前运行验证
- 在审查期间使用 `lean-spec tokens --all --sort-by tokens` 进行更严格的检查
...
✅ 通过（43 个规范）
  • 040-api-design：1,140 令牌 ✅
  • 041-testing-strategy：1,020 令牌 ✅
  • 043-launch-plan：1,310 令牌 ✅
  ...

⚠️  警告（1 个规范）
  • 058-docs-restructure：3,620 令牌
    → 接近限制，考虑简化或拆分

🔴 错误（1 个规范）
  • 042-complex-feature：5,180 令牌
    → 超过限制，必须拆分为子规范
    → 建议：将计划和发布迁移至 DESIGN.md / IMPLEMENTATION.md
...
- **[理解 LeanSpec](/zh-Hans/docs/guide/understanding-leanspec)** - 第一原则和上下文经济
