...
- **Node.js**：确保您已安装 Node.js（版本 20 或更高）。您可以从 [nodejs.org](https://nodejs.org/) 下载。
- **AI 工具**：如果您计划与 AI 编码代理集成（如 GitHub Copilot、Claude 等），请确保设置了您首选的工具。

## 安装

LeanSpec 可以用 npm 全局安装。
...
**学习基础知识：**
- [规范篇](/zh-Hans/docs/guide/terminology/spec) - 关键 SDD 术语
- [第一原则](/zh-Hans/docs/advanced/first-principles) - 5 个基础原则
- [理解 LeanSpec](/zh-Hans/docs/guide/understanding-leanspec) - 核心概念和使用场景
