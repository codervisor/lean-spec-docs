...
> 🎥 视频演练（Loom）— 即将推出。下面的每个步骤都引用了我们在演示中涵盖的时间戳。
...
## 步骤 4：使用 Lean 原则审查（06:30）
浏览草稿并检查：

- **上下文经济** — 规范是否低于约 300 行？如果不是，询问代理哪些部分应该移到子规范。
- **信噪比** — 删除重复和营销术语。
...
需要更多上下文？重新访问[什么是 LeanSpec？](/docs/guide/what-is-leanspec)或 [SDD 工作流程](/docs/guide/terminology/sdd-workflow)。
